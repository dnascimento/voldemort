...
_MSGTOMANAGER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='trackMsgFromClients', full_name='voldemort.MsgToManager.trackMsgFromClients', index=2,
...
_MSGTOMANAGER.fields_by_name['trackMsgFromClients'].message_type = _TRACKMSG

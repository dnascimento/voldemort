...
_UPDATESTOREDEFINITIONS.fields_by_name['versioned'].message_type = voldemort_client_pb2._VERSIONED
...
class UpdateStoreDefinitions(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType

...
public interface Time {
    ...
    public static final long NS_PER_MS = US_PER_MS * NS_PER_US;
    public static final long MS_PER_SECOND = 1000;
    public static final long US_PER_SECOND = US_PER_MS * MS_PER_SECOND;
    public static final long NS_PER_SECOND = NS_PER_US * US_PER_SECOND;
    public static final long SECONDS_PER_HOUR = 60 * 60;
    public static final long SECONDS_PER_DAY = HOURS_PER_DAY * SECONDS_PER_HOUR;
    public static final long MS_PER_HOUR = SECONDS_PER_HOUR * MS_PER_SECOND;

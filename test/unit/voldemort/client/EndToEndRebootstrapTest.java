...
public class EndToEndRebootstrapTest {
    ...
    private void sanityTestClientOps() {
        ...
        String value = "SF";
        try {
            storeClient.put(key, value, new SRD());
            String received = storeClient.getValue(key, new SRD());
    ...
    private String getPropertyFromClientInfo(String propertyName) {
        ...
        try {
            String clientInfo = clientRegistryStore.getSysStore(storeClient.getClientId(), new SRD())
                                                   .getValue();
     ...
     * 1. Do some operations to validate that the client is correctly
     * initialized.
     ...
     * 4. Whether the client has automatically bootstrapped is verified by
     * checking

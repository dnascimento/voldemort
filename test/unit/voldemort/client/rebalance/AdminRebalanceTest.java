...
public class AdminRebalanceTest {
    ...
    public void testRebalanceNodeRW() throws IOException {
        ...
        try {
            ...
            for(VoldemortServer server: servers) {
                server.getMetadataStore().put(MetadataStore.CLUSTER_KEY, finalCluster, new SRD());
            }
            ...
            for(Entry<ByteArray, byte[]> entry: primaryEntriesMoved.entrySet()) {
                assertSame("entry should be present at store",
                           1,
                           storeTest0.get(entry.getKey(), null, new SRD()).size());
                assertEquals("entry value should match",
                             new String(entry.getValue()),
                             new String(storeTest0.get(entry.getKey(), null, new SRD())
                                                  .get(0)
                                                  .getValue()));
                ...
                assertSame("entry should be present in store test2 ",
                           1,
                           storeTest20.get(entry.getKey(), null, new SRD()).size());
                assertEquals("entry value should match",
                             new String(entry.getValue()),
                             new String(storeTest20.get(entry.getKey(), null, new SRD())
                                                   .get(0)
                                                   .getValue()));
            }
            ...
            for(Entry<ByteArray, byte[]> entry: secondaryEntriesMoved.entrySet()) {
                assertSame("entry should be present at store",
                           1,
                           storeTest2.get(entry.getKey(), null, new SRD()).size());
                assertEquals("entry value should match",
                             new String(entry.getValue()),
                             new String(storeTest2.get(entry.getKey(), null, new SRD())
                                                  .get(0)
                                                  .getValue()));
            }
    ...
    public void testRebalanceNodeRW2() throws IOException {
        ...
        try {
            ...
            for(Entry<ByteArray, byte[]> entry: primaryEntriesMoved.entrySet()) {
                ...
                assertSame("entry should be present at store",
                           1,
                           storeTest1.get(entry.getKey(), null, new SRD()).size());
                assertEquals("entry value should match",
                             new String(entry.getValue()),
                             new String(storeTest1.get(entry.getKey(), null, new SRD())
                                                  .get(0)
                                                  .getValue()));
                ...
                assertSame("entry should be present at store",
                           1,
                           storeTest3.get(entry.getKey(), null, new SRD()).size());
                assertEquals("entry value should match",
                             new String(entry.getValue()),
                             new String(storeTest3.get(entry.getKey(), null, new SRD())
                                                  .get(0)
                                                  .getValue()));
                ...
                assertSame("entry should be present at store",
                           1,
                           storeTest00.get(entry.getKey(), null, new SRD()).size());
                assertEquals("entry value should match",
                             new String(entry.getValue()),
                             new String(storeTest00.get(entry.getKey(), null, new SRD())
                                                   .get(0)
                                                   .getValue()));
                ...
                assertSame("entry should be present at store",
                           1,
                           storeTest30.get(entry.getKey(), null, new SRD()).size());
                assertEquals("entry value should match",
                             new String(entry.getValue()),
                             new String(storeTest30.get(entry.getKey(), null, new SRD())
                                                   .get(0)
                                                   .getValue()));
    ...
    private void cleanUpAllState() {
        for(VoldemortServer server: servers) {
            ...
            if(server != null) {
                ...
                server.getMetadataStore().put(MetadataStore.CLUSTER_KEY, currentCluster, new SRD());

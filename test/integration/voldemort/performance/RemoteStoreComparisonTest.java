    ...
    public static void main(String[] args) throws Exception {
        ...
        PerformanceTest memWriteTest = new PerformanceTest() {
            ...
            public void doOperation(int i) {
                ...
                memStore.put(key, new Versioned<byte[]>(key), null, 0L);
            }
        };
        System.out.println("###########################################");
        ...
        PerformanceTest memReadTest = new PerformanceTest() {
            ...
            public void doOperation(int i) {
                try {
                    memStore.get(String.valueOf(i).getBytes(), null, 0L);
                } catch(Exception e) {
        ...
        PerformanceTest socketWriteTest = new PerformanceTest() {
            ...
            public void doOperation(int i) {
                ...
                socketStore.put(key, new Versioned<byte[]>(bytes), null, 0L);
            }
        };
        System.out.println("###########################################");
        ...
        PerformanceTest socketReadTest = new PerformanceTest() {
            ...
            public void doOperation(int i) {
                try {
                    socketStore.get(TestUtils.toByteArray(String.valueOf(i)), null, 0L);
                } catch(Exception e) {
                    System.out.println("Failure on i = " + i);
                    e.printStackTrace();
                }
        ...
        PerformanceTest httpWriteTest = new PerformanceTest() {
            ...
            public void doOperation(int i) {
                byte[] key = String.valueOf(i).getBytes();
                httpStore.put(new ByteArray(key), new Versioned<byte[]>(key), null, 0L);
            }
        };
        System.out.println("###########################################");
        ...
        PerformanceTest httpReadTest = new PerformanceTest() {
            ...
            @Override
            public void doOperation(int i) {
                httpStore.get(new ByteArray(String.valueOf(i).getBytes()), null, 0L);
            }
        };

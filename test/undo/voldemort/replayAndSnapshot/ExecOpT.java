...
public class ExecOpT extends Thread {
    ...
    public ExecOpT(ByteArray key, OpType type, DBProxy stub, KeyMap db, SRD... ruds) {
        super();
    ...
    public void exec() {
        for(int i = 0; i < ruds.length; i++) {
            ...
            try {
                ...
                // scheduler.deleteStart(key, new SRD(op.rid, srd.branch,
                // srd.restrain));
                // System.out.println("Deleting...: " + op.rid);
                // sleep(1000);
                // scheduler.deleteEnd(key, new SRD(op.rid, srd.branch,
                // srd.restrain));
                // System.out.println("Deleted: " + op.rid);
                // break;
                // case Put:
                // System.out.println("Try put: " + op.rid);
                // scheduler.putStart(key, new SRD(op.rid, srd.branch,
                // srd.restrain));
                // System.out.println("Putting...: " + op.rid);
                // sleep(1000);
                // scheduler.putEnd(key, new SRD(op.rid, srd.branch,
                // srd.restrain));
                // System.out.println("putted: " + op.rid);
                // break;
                // case Get:
                // System.out.println("Try get: " + op.rid);
                // scheduler.getStart(key, new SRD(op.rid, srd.branch,
                // srd.restrain));
                // System.out.println("getting...: " + op.rid);
                // sleep(1000);
                // scheduler.getEnd(key, new SRD(op.rid, srd.branch,
                // srd.restrain));
                // System.out.println("got: " + op.rid);
                // break;
                // case GetVersion:
                // System.out.println("Try get version: " + op.rid);
                // scheduler.getVersion(key, new SRD(op.rid, srd.branch,
                // srd.restrain));
                // System.out.println("got...: " + op.rid);
                // sleep(1000);
                // scheduler.getEnd(key, new SRD(op.rid, srd.branch,
                ...
                // break;
                    case UNLOCK:
                        ...
                        scheduler.unlockKeys(Arrays.asList(key), new SRD(op.rid,
                                                                        srd.branch,
                                                                        srd.restrain));
